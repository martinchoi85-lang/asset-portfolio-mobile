...
CREATE TABLE public.transactions (
  ...
  is_external_flow boolean DEFAULT true,
...
CREATE TABLE public.import_profiles (
  ...
  trade_type_map jsonb NOT NULL DEFAULT '{}'::jsonb,
  numeric_columns jsonb NOT NULL DEFAULT '[]'::jsonb,
  preprocess_func_name text,
  ...
  CONSTRAINT fk_import_profiles_user FOREIGN KEY (user_id) REFERENCES public.users(id)
);
